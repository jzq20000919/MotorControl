...
{
LL_GPIO_LockPin(M1_SHUNT_P_W_GPIO_Port, M1_SHUNT_P_W_Pin);
...
LL_GPIO_LockPin(M1_SHUNT_P_U_GPIO_Port, M1_SHUNT_P_U_Pin);
...
LL_GPIO_LockPin(M1_SHUNT_P_V_GPIO_Port, M1_SHUNT_P_V_Pin);
