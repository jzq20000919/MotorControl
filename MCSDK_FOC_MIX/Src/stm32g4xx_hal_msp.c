...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, M1_BUS_VOLTAGE_Pin|M1_TEMPERATURE_Pin|M1_CURR_AMPL_W_Pin);
...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PA3     ------> OPAMP1_VINM
    */
    GPIO_InitStruct.Pin = M1_SHUNT_P_U_Pin|M1_CURR_AMP_U_Pin|M1_SHUNT_M_U_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  else if(hopamp->Instance==OPAMP2)
  {
    ...
    PA7     ------> OPAMP2_VINP
    */
    GPIO_InitStruct.Pin = M1_SHUNT_M_V_Pin|M1_CURR_AMP_V_Pin|M1_SHUNT_P_V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  else if(hopamp->Instance==OPAMP3)
  {
    ...
    PB2     ------> OPAMP3_VINM
    */
    GPIO_InitStruct.Pin = M1_SHUNT_P_W_Pin|M1_CURR_AMP_W_Pin|M1_SHUNT_M_W_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PA3     ------> OPAMP1_VINM
    */
    HAL_GPIO_DeInit(GPIOA, M1_SHUNT_P_U_Pin|M1_CURR_AMP_U_Pin|M1_SHUNT_M_U_Pin);
  ...
  else if(hopamp->Instance==OPAMP2)
  {
    ...
    PA7     ------> OPAMP2_VINP
    */
    HAL_GPIO_DeInit(GPIOA, M1_SHUNT_M_V_Pin|M1_CURR_AMP_V_Pin|M1_SHUNT_P_V_Pin);
  ...
  else if(hopamp->Instance==OPAMP3)
  {
    ...
    PB2     ------> OPAMP3_VINM
    */
    HAL_GPIO_DeInit(GPIOB, M1_SHUNT_P_W_Pin|M1_CURR_AMP_W_Pin|M1_SHUNT_M_W_Pin);
...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* htim_pwm)
{
  if(htim_pwm->Instance==TIM1)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, M1_PWM_UL_Pin|M1_PWM_WL_Pin);

    HAL_GPIO_DeInit(GPIOA, M1_PWM_UH_Pin|M1_PWM_VH_Pin|M1_PWM_WH_Pin|M1_PWM_VL_Pin);
