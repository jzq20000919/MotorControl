...
static inline void User_Parameter_Init(SguanFOC_System_STRUCT *user){
     ...
     */
    user->transfer.Current_D.Kp = 0.86f;
    user->transfer.Current_D.Ki = 2550.0f;
    user->transfer.Current_Q.Kp = 0.86f;
    user->transfer.Current_Q.Ki = 2550.0f;
    user->transfer.Velocity.Kp = 0.012f;
    user->transfer.Velocity.Ki = 0.08f;
