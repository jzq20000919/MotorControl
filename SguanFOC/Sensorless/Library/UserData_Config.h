...
/* X-STAR-S / STM32G431RBT6 sensorless board profile.
 * Mode 8 is Sensorless SMO: IF forced start followed by SMO handover.
 */
#undef Define_Run_Mode
#define Define_Run_Mode 8
#undef Switch_MOTOR_Control_Vel
#define Switch_MOTOR_Control_Vel 0
#undef Open_Current_Feedforward
#define Open_Current_Feedforward 0
#undef TIM_T
#define TIM_T (1.0f / 16000.0f)
