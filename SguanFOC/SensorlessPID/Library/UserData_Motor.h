...
static inline void User_Motor_Init(SguanFOC_System_STRUCT *user){
    ...
    /* X-STAR-S / STM32G431RBT6 board and motor calibration override. */
    user->motor.identify.Rs = 2.55f;
    user->motor.identify.Ld = 0.00086f;
    user->motor.identify.Lq = 0.00086f;
    user->motor.identify.Flux = 0.02246532f;
    user->motor.Poles = 7U;
    user->motor.VBUS = 20.0f;
    user->motor.Motor_Dir = 1;
    user->motor.PWM_Dir = -1;
    user->motor.Duty = SGUAN_SENSORLESS_PID_TIM1_ARR;
    user->motor.Current_Dir0 = SGUAN_SENSORLESS_PID_PHASE_V_DIR;
    user->motor.Current_Dir1 = SGUAN_SENSORLESS_PID_PHASE_W_DIR;
    user->motor.Current_Num = 2U;
    user->motor.ADC_Precision = 4096U;
    user->motor.Amplifier = 10.0f;
    user->motor.MCU_Voltage = 3.3f;
    user->motor.Sampling_Rs = 0.003f;

    user->safe.VBUS_MAX = 28.0f;
    user->safe.VBUS_MIM = 8.0f;
    user->safe.Dcur_MAX = 2.0f;
    user->safe.Qcur_MAX = 2.0f;
